//Create a structure in C++ containing the details of Students as details below and a main function to execute the structure.
...
int main() {
    ...
    cout << "Current CGPA: " << s.currentCGPA << endl;
